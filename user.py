...
{bot}{interface} Mocha latte. It is nice in both look and taste.

{user}{interface} What is it?

{bot}{interface} A mocha latte is a coffee-based drink that combines espresso, steamed milk, and chocolate. It typically has a rich and creamy taste with a balance of coffee and chocolate flavors. The espresso adds a bold and slightly bitter taste, while the chocolate brings sweetness and richness to the drink. The steamed milk gives the latte a smooth and creamy texture. Overall, a mocha latte is a delicious and indulgent treat for coffee and chocolate lovers.

{user}{interface} Cool! I'll surely try this next time.

{bot}{interface} It's pleasent to have a drink with you. Let's talk a while then.
