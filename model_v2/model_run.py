...
# model, dev1, dtype1, dev2, dtype2, dev1_layers
    ...
    def __init__(self, args):
        ...
        with torch.no_grad():
            ...
            for x in keys:
                ...
                DEVICE = dev[0] if layer_id < layer_sep else dev[1]
                DTYPE = get_dtype(dtype[0]) if layer_id < layer_sep else get_dtype(dtype[1])
